...
/**
 * Clase que representa al enemigo tipo Tiburón. Tiene lógica de persecución y
 * ataque rápido cuando ve al jugador.
 */
public class Tiburon extends Enemigos {
	...
	protected void atacarEnMovimiento(int[][] lvlData, Jugando jugando) {
		...
		if (PuedeMoverAqui(cajaColision.x + xSpeed * 4, cajaColision.y, cajaColision.width, cajaColision.height,
				lvlData))
		...
		// Si no puede avanzar (chocó con algo), vuelve a estado IDLE y muestra
		// exclamación.
		cambiarEstado(IDLE);
